...
; TOPDOWN-NEXT:    [[UNPACK1:%.*]] = extractelement <2 x float> [[VEC]], i32 1, !sandboxvec [[META0]]
; TOPDOWN-NEXT:    store float [[SUB0]], ptr [[PTR0]], align 4
; TOPDOWN-NEXT:    store float [[UNPACK1]], ptr [[PTR1]], align 4
...
; TOPDOWN-NEXT:    [[UNPACK:%.*]] = shufflevector <4 x float> [[VEC]], <4 x float> poison, <2 x i32> <i32 0, i32 1>, !sandboxvec [[META2]]
; TOPDOWN-NEXT:    [[SUB1:%.*]] = shufflevector <4 x float> [[VEC]], <4 x float> poison, <2 x i32> <i32 2, i32 3>, !sandboxvec [[META2]]
; TOPDOWN-NEXT:    store <2 x float> [[UNPACK]], ptr [[PTR0]], align 8
; TOPDOWN-NEXT:    store <2 x float> [[SUB1]], ptr [[PTR1]], align 8
; TOPDOWN-NEXT:    [[USER:%.*]] = fneg <2 x float> [[SUB1]]
; TOPDOWN-NEXT:    ret void
;
